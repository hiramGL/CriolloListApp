...
export default function MessagesPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const enriched = await Promise.all(data.map(async (conv) => {
        ...
        const { data: userInfo } = await supabase.from("users").select("full_name, profile_image").eq("id", otherId).single()
  ...
  useEffect(() => {
    ...
    // 👇 Real-time subscription to messages in this conversation
